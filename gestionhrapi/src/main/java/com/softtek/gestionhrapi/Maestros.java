...
public class Maestros {
	...
	public List<String> getRoles() throws PropiedadNoEncontradaExcepcion,
		...
		LOG.debug("Se ha cargado los roles " + roles.toString());
		return roles;
		//return ArqSpringContext.getPropiedadList("maestroshr.roles");
	}
}
